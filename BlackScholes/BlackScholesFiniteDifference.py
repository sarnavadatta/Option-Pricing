...
class BlackScholesFD:
    ...
    def __init__(self, S, K, days, r, sigma, S_max_factor=4.0, M=400, N_time=400):
        """
        S : underlying spot
        K : strike
...
if __name__ == "__main__":
    ...
    print("Finite Difference Crank-Nicolson Results (M={}, N={})".format(M, N_time))
    print("-----------------------------------------------------")
    print("Call Option:")
    for k, v in fd_call.items():
        print(f"{k:6s}: {v:10.6f}")     
    print("-----------------------------------------------------")
    print("Put Option:")   
    for k, v in fd_put.items():
        print(f"{k:6s}: {v:10.6f}")
    print("-----------------------------------------------------")
